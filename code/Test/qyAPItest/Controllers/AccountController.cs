...
namespace APITest.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult BackLogin()
        {
            ...
            var WeixinCorpId = "wx2a3f5167603c5caf";
            var WeixinCorpSecret = "07794839c40bfecc0e1f89322921558e";
           // var config = WeChatCommonService.lstSysWeChatConfig.FirstOrDefault(a => a.WeixinAppId == "Forsteo");
            ...
            try
            {
                ...
                LogManager.GetLogger(this.GetType()).Debug("getting config: {0}",WeixinCorpId);
                //ViewBag.ReturnUrl = returnUrl;
                if (Request["code"] != null)
                {
                    ...
                    var Token = OAuthApi.GetAccessToken(WeixinCorpId, WeixinCorpSecret, code);
                    ...
                    var userinfo = UserApi.Info(WeixinCorpId, WeixinCorpSecret, Token.openid);
                   ...
                   // await _authenticationService.SignInNoDB(user, true);
                    ...
                    // var claimsIdentity = await UserManager..CreateIdentityAsync((SysUser)user, DefaultAuthenticationTypes.ApplicationCookie);
                    ...
                    claimsIdentity.AddClaim(new Claim(ClaimsIdentity.DefaultNameClaimType, user.UserName, "http://www.w3.org/2001/XMLSchema#string"));
