...
namespace Innocellence.Weixin.CommonService.CustomMessageHandler
{
    ...
    public partial class CustomMessageHandler
    {
        ...
        {
            //获取Innocellence.Weixin.MP.dll版本信息
            var fileVersionInfo = FileVersionInfo.GetVersionInfo(HttpContext.Current.Server.MapPath("~/bin/Innocellence.Weixin.MP.dll"));
            var version = string.Format("{0}.{1}", fileVersionInfo.FileMajorPart, fileVersionInfo.FileMinorPart);
            return string.Format(
@"欢迎关注【Innocellence.Weixin.MP 微信公众平台SDK】，当前运行版本：v{0}。
...
Nuget地址：https://www.nuget.org/packages/Innocellence.Weixin.MP",
                version);
        }
                ...
                case "SubClickRoot_News":
                    {
                        ...
                        strongResponseMessage.Articles.Add(new Article()
                        {
                            ...
                            PicUrl = "http://weixin.Innocellence.com/Images/qrcode.jpg",
                ...
                case "SubClickRoot_Music":
                    {
                       ...
                       // var accessToken = Innocellence.Weixin.MP.CommonAPIs.AccessTokenContainer.GetToken(appId, appSecret);
                        var uploadResult = Innocellence.Weixin.MP.AdvancedAPIs.MediaApi.UploadTemporaryMedia(appId, appSecret, UploadMediaFileType.thumb,
                        ...
                        strongResponseMessage.Music.MusicUrl = "http://weixin.Innocellence.com/Content/music1.mp3";
                        strongResponseMessage.Music.HQMusicUrl = "http://weixin.Innocellence.com/Content/music1.mp3";
                ...
                case "OAuth"://OAuth授权测试
                    {
                        ...
                        {
                            Title = "OAuth2.0测试",
                            Description = "点击【查看全文】进入授权页面。\r\n注意：此页面仅供测试（是专门的一个临时测试账号的授权，并非Innocellence.Weixin.MP SDK官方账号，所以如果授权后出现错误页面数正常情况），测试号随时可能过期。请将此DEMO部署到您自己的服务器上，并使用自己的appid和secret。",
                            Url = "http://weixin.Innocellence.com/oauth2",
                            PicUrl = "http://weixin.Innocellence.com/Images/qrcode.jpg"
                        });
                        reponseMessage = strongResponseMessage;
                    }
