...
using Innocellence.Weixin.MP.Entities.GoogleMap;
using Innocellence.Weixin.MP.Helpers;
using Innocellence.Weixin.Entities;

namespace Innocellence.Weixin.CommonService
{
    public class LocationService
    {
        public ResponseMessageNews GetResponseMessage(RequestMessageLocation requestMessage)
        {
            ...
            responseMessage.Articles.Add(new Article()
            {
                ...
                Description = "Innocellence.Weixin.MK SDK地址",
                PicUrl = "http://weixin.Innocellence.com/images/logo.jpg",
