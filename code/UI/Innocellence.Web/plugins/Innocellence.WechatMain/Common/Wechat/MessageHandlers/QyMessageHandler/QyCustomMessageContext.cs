...
namespace Innocellence.Weixin.CommonService.QyMessageHandler
{
    public class QyCustomMessageContext : MessageContext<IRequestMessageBase,IResponseMessageBase>
    {
        ...
        void CustomMessageContext_MessageContextRemoved(object sender, Innocellence.Weixin.Context.WeixinContextRemovedEventArgs<IRequestMessageBase, IResponseMessageBase> e)
        {
