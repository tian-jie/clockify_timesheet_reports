...
$(function () {
    ...
    test('Paste zone initialization', function () {
        ok($('#fileupload').fileupload({ pasteZone: document }).fileupload('option', 'pasteZone').length);
    });
    ...
    test('limitMultiFileUploads', function () {
        expect(3);
        var fu = $('#fileupload').fileupload(),
            param = { files: [{ name: '1' }, { name: '2' }, { name: '3' }, { name: '4' }, { name: '5' }] },
            index = 1;
        (fu.data('blueimp-fileupload') || fu.data('fileupload'))._isXHRUpload = function () {
            return true;
        };
    ...
    test('limitMultiFileUploadSize', function () {
        expect(7);
        var fu = $('#fileupload').fileupload(),
            param = { files: [{ name: '1-1', size: 100000 }, { name: '1-2', size: 40000 }, { name: '2-1', size: 100000 }, { name: '3-1', size: 50000 }, { name: '3-2', size: 40000 }, { name: '4-1', size: 45000 } // New request due to limitMultiFileUploads
            ] },
            param2 = { files: [{ name: '5-1' }, { name: '5-2' }, { name: '6-1' }, { name: '6-2' }, { name: '7-1' }] },
            index = 1;
        (fu.data('blueimp-fileupload') || fu.data('fileupload'))._isXHRUpload = function () {
            return true;
        };
    ...
    asyncTest('sequentialUploads', function () {
        expect(6);
        var param = { files: [{ name: '1' }, { name: '2' }, { name: '3' }, { name: '4' }, { name: '5' }, { name: '6' }] },
            addIndex = 0,
            sendIndex = 0,
            loadIndex = 0,
            fu = $('#fileupload').fileupload({
    ...
    asyncTest('limitConcurrentUploads', function () {
        expect(12);
        var param = { files: [{ name: '1' }, { name: '2' }, { name: '3' }, { name: '4' }, { name: '5' }, { name: '6' }, { name: '7' }, { name: '8' }, { name: '9' }, { name: '10' }, { name: '11' }, { name: '12' }] },
            addIndex = 0,
            sendIndex = 0,
            loadIndex = 0,
            fu = $('#fileupload').fileupload({
    ...
    test('autoUpload', function () {
        ...
        }).fileupload('add', { files: [{ name: 'test' }] }).fileupload('option', 'autoUpload', false).fileupload('add', { files: [{ name: 'test' }] });
    });
    ...
    test('maxNumberOfFiles', function () {
        ...
        $('#fileupload').fileupload({
            ...
            stop: $.noop
        }).fileupload('add', { files: [{ name: addIndex += 1 }] }).fileupload('add', { files: [{ name: addIndex += 1 }] }).fileupload('add', { files: [{ name: addIndex += 1 }] }).fileupload('add', { files: [{ name: 'test' }] });
    });
