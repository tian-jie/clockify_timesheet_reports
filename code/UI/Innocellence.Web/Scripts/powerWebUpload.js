...
(function ($, window) {
    ...
    function initWebUpload(item, options) {
        ...
        var webuploaderoptions = $.extend({
            ...
            // swf文件路径
            swf: applicationPath + '/Modules/Innocellence.GSK.WeChat.Module/Scripts/fileupload/webuploader/Uploader.swf',
        ...
        uploader.on('uploadSuccess', function (file, response) {
            ...
            if (opts.myfiletype.title == "Video") {
                ...
                target.find('#' + file.id).siblings().remove();
                var mfname = response.filePath.replace("/uploadfile/upload/image/", "");
