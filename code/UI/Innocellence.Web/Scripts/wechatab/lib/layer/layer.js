...
function (a, b) {
    ...
    f.pt.offset = function () {
        ...
        f ? (a.offsetTop = b.offset[0], a.offsetLeft = b.offset[1] || a.offsetLeft) : "auto" !== b.offset && (a.offsetTop = b.offset, "rb" === b.offset && (a.offsetTop = d.height() - e[1], a.offsetLeft = d.width() - e[0]), "rm" === b.offset && (a.offsetTop = (d.height() - e[1])/10, a.offsetLeft = d.width() - e[0])),
