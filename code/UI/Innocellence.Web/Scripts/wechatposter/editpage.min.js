(function() {
    ...
    function slidePageEditWord() {
        ...
        loopArray(colors, function(color, i) {
            var colorBox = element("div", {
                classList: "edit-color-box"
            }, selectColorBorder);
            var colorItem = element("div", {
                classList: "edit-color-item"
            }, colorBox);
        ...
        loopArray(fontFamily, function(ff, i) {
            ...
            var border = element("div", {
                classList: "edit-font-family-item"
            }, familyBorder);
    ...
    function mappingToScreen(page) {
        page.pageData = {
            AllowCustom: true,
            Guid: "ee150a4a-ef88-4e3b-87a8-de6f003b599d",
            Id: 145627866,
            Layout: "MutipleImage01",
            LayoutId: 39,
            Medias: [
                {
                    ActionLink: null,
                    Attributes: { "X": 35, "Y": 61, "W": 251, "H": 381, "R": null, "Color": null, "Alpha": null, "Shape": 0, "Size": null, "MaxLength": null, "TextAlignment": null, "FontFamily": null, "ShadowEnabled": false, "FontStyle": 0, "LineHeight": 0, "FontDirection": 0, "HasBackground": false, "BackgroundBorder": 0, "BackgroundWidth": 0, "BackgroundHeight": 0, "BackgroundColor": null, "HasBorder": false, "BorderWidth": 0, "BorderColor": null, "BorderRadius": null, "Animation": null, "LetterSpace": 0.0, "Polygon": 0, "AnimationDelay": null, "AnimationDuration": null },
                    Category: 8,
                    Guid: "806ad632-dec5-4a14-b418-b27b5ee400eb",
                    ID: 103739767,
                    Medias: [11874, 11875, 11876, 11878],
                    Text: null,
                    Uri: null
                },
                {
                    ...
                    Attributes: null,
                    Category: 2,
                    Guid: "19432b8b-f1ee-47ff-b8d2-ee2976ffcd82",
                    ID: 11874,
                    Medias: null,
                    Text: null,
                    Uri: "http://img01.cloud7.com.cn/51e310717d92ecea943d094b99e8b129.jpg"
                }
            ]
        };
        //};
        ...
        var virtualLayer = element("div", {
            classList: "virtual-layer"
        }, null);
        if (!notSupportList[page.pageInfo.pageData.LayoutId]) {
            ...
            loopArray(page.querySelectorAll(".layout-component-from-data"), function(plug, i) {
                ...
                var editableObj = element("div", {
                    classList: "virtual-layer-editable-obj"
                }, virtualLayer);
                var info = null;
                if (plug.dataSource.from == "image") {
                    ...
                    if (page.pageInfo.imgMediaInfo[plug.dataSource.index].Category == 57) {
                        ...
                        if (page.pageInfo.imgMediaInfo[plug.dataSource.index].Category == 7) {
                            var dragObj = element("div", {
                                classList: "virtual-layer-editable-drag-obj"
                            }, editableObj);
                            ...
                            onTap(editableObj, function() {
                                if (editableObj.classList.contains("select")) {
                                    ...
                                    $(".slide-page-edit-bgimg .crop-img-border").cropit({
                                        imageState: {
                                            src: page.pageInfo.imgMediaInfo[plug.dataSource.index].Uri
                                        }
                                    });
    ...
    function initPageView() {
        ...
        fpInvokeAPI.getPageData(function(data) {
            ...
            querySelector(".edit-setting-page .page-turning-gesture").onchange = function() {
                var val = this.value,
                    switcher = querySelector(".edit-setting-page .page-turning-animation");
                if (val == "push") {
                    switcher.disabled = true;
                    switcher.style.color = "#cfcfcf"
                } else {
