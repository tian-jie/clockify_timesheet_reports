...
(function () {
    ...
    function initTabs() {
        ...
        if (img && img.tagName && img.tagName.toLowerCase() == 'img') {
            ...
            setTabFocus('remote');//setTabFocus('upload'); remove upload tab.
        }
    }
    ...
    RemoteImage.prototype = {
        ...
        setImage: function (img) {
            ...
            if (src) {
                /* 设置表单内容 */
                $G("width").value = img.getAttribute("width").replace('%','') || '';
        ...
        setPreview: function () {
            var url = $G('url').value,
                ...
                title = $G('title').value,
                preview = $G('simple_upload'),//modify preview to simple_upload
                width,
                height;
            ...
            if (url) {
                ...
                $('#videoImage').attr({'src': url,'border': border + 'px solid #000','title':title });
            }
        },
        getInsertList: function () {
            ...
            if (data['url']) {
                return [{
                    src: data['url'],
                    _src: data['url'],
                    width: data['width'] == '' ? '100%' : data['width']+'%',//modify px to %
                    height: data['height'] || '',
                    border: data['border'] || '',
