...
artDialog.alertOkCallBack = function (content, title, callback) {
    return dialog({
        title: title ? title : '提示',
        id: 'Alert',
        icon: 'warning',
