...
namespace Innocellence.Web.Models.Plugins
{
    ...
    public partial class PluginModel : EntityBase<int> //: BaseNopModel, ILocalizedModel<PluginLocalizedModel>
    {
        public PluginModel()
        {
    ...
    public partial class PluginLocalizedModel : EntityBase<int> //: ILocalizedModelLocal
    {
